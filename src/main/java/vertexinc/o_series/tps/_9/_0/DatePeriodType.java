...
@XmlSeeAlso({
    vertexinc.o_series.tps._9._0.FindChangedTaxAreaIdsRequestType.DatePeriod.class,
    vertexinc.o_series.tps._9._0.IsTaxAreaChangedRequestType.DatePeriod.class
})
