...
/**
 * Line Item declaration for Invoice Response message.
 * 
 * <p>Java class for LineItemISOType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemISOType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemISOType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "LineItemISOType", propOrder = {
    "seller",
    "customer",
    "taxOverride",
    "impositionToProcess",
...
public class LineItemISOType {
    ...
    protected List<LineItemISOType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemISOType }
     * 
     * 
     */
    public List<LineItemISOType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemISOType>();
        }
