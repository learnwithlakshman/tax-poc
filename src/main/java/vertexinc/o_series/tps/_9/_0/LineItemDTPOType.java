...
/**
 * Line Item declaration for Distribute CUT Response message.
 * 
 * <p>Java class for LineItemDTPOType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemDTPOType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemDTPOType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "LineItemDTPOType", propOrder = {
    "buyer",
    "vendor",
    "taxOverride",
    "impositionToProcess",
...
public class LineItemDTPOType {
    ...
    protected List<LineItemDTPOType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemDTPOType }
     * 
     * 
     */
    public List<LineItemDTPOType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemDTPOType>();
        }
