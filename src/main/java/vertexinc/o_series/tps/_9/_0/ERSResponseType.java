...
/**
 * ERS Response message.
 * 
 * <p>Java class for ERSResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ERSResponseType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemEPTOType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "ERSResponseType", propOrder = {
    "currency",
    "originalCurrency",
    "companyCodeCurrency",
    "buyer",
    ...
    extends TaxTransactionResponseType
{
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemEPTOType }
     * 
     * 
     */
    public List<LineItemEPTOType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemEPTOType>();
        }
