 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemIVSIType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "InvoiceVerificationRequestType", propOrder = {
    "currency",
    "originalCurrency",
    "companyCodeCurrency",
    "buyer",
...
public class InvoiceVerificationRequestType
    extends TaxTransactionRequestType
{
    ...
    protected List<LineItemIVSIType> lineItem;
    ...
    /**
     * The amount of tax on the invoice to be used in the verification process.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemIVSIType }
     * 
     * 
     */
    public List<LineItemIVSIType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemIVSIType>();
        }
