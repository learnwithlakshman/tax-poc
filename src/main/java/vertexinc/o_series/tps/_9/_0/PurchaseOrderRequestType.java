...
/**
 * The request used to estimate the sales tax on intended purchases made by a Buyer. The intended purchase of goods or services including tax is used as input to generate the purchase order. The ultimate use of the goods or services typically dictates the taxability of the purchase. Note that because these events are used to estimate tax, no transactions are stored in the Tax Journal.
 * 
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemPOTIType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:vertexinc:o-series:tps:9:0}PurchaseOrderTransactionGroup"/&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
public class PurchaseOrderRequestType
    extends TaxTransactionRequestType
{
    ...
    protected List<LineItemPOTIType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemPOTIType }
     * 
     * 
     */
    public List<LineItemPOTIType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemPOTIType>();
        }
