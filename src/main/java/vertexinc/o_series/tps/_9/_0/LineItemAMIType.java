...
/**
 * Line Item declaration for Asset Movement Request message.
 * 
 * <p>Java class for LineItemAMIType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemAMIType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Cost" type="{urn:vertexinc:o-series:tps:9:0}AmountType" minOccurs="0"/&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemAMIType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "LineItemAMIType", propOrder = {
    "owner",
    "taxOverride",
    "impositionToProcess",
...
@XmlSeeAlso({
    vertexinc.o_series.tps._9._0.AssetMovementRequestType.LineItem.class
})
public class LineItemAMIType {
    ...
    protected List<LineItemAMIType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemAMIType }
     * 
     * 
     */
    public List<LineItemAMIType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemAMIType>();
        }
