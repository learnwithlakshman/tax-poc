...
/**
 * The request used to calculate consumer use tax when withdrawing inventory for a specific internal project or task. Consumer use tax that results from an Inventory Removal transaction should be accrued at the final destination location of the inventory and is written to the Tax Journal.
 * 
 * 
 * <p>Java class for InventoryRemovalRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InventoryRemovalRequestType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemIRMIType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "InventoryRemovalRequestType", propOrder = {
    "currency",
    "originalCurrency",
    "companyCodeCurrency",
    "owner",
...
public class InventoryRemovalRequestType
    extends TaxTransactionRequestType
{
    ...
    protected List<LineItemIRMIType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemIRMIType }
     * 
     * 
     */
    public List<LineItemIRMIType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemIRMIType>();
        }
