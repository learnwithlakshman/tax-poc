...
/**
 * The request used to reconcile transactions between a Vertex O Series product and your
 *                 host system. Any changes made to a financial document can impact previously calculated transactions
 *                 already written to the Tax Journal. This request enables you to accept changes made to a financial
 *                 document and update the transaction in the Tax Journal accordingly.
 *             
 * 
 * <p>Java class for AccrualSyncRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AccrualSyncRequestType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "AccrualSyncRequestType", propOrder = {
    "currency",
    "originalCurrency",
    "companyCodeCurrency",
    "buyer",
...
public class AccrualSyncRequestType
