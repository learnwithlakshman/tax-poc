...
/**
 * Line Item declaration for Accrual Synchronization Response message.
 * 
 * <p>Java class for LineItemASOType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemASOType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemASOType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "LineItemASOType", propOrder = {
    "buyer",
    "vendor",
    "taxOverride",
    "impositionToProcess",
...
@XmlSeeAlso({
    vertexinc.o_series.tps._9._0.AccrualSyncResponseType.LineItem.class
})
public class LineItemASOType {
    ...
    protected List<LineItemASOType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemASOType }
     * 
     * 
     */
    public List<LineItemASOType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemASOType>();
        }
