...
/**
 * Line Item declaration for Account Payable Invoice Synchronization Request message.
 * 
 * <p>Java class for LineItemAPIIType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemAPIIType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemAPIIType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "LineItemAPIIType", propOrder = {
    "buyer",
    "vendor",
    "taxOverride",
    "impositionToProcess",
...
public class LineItemAPIIType {
    ...
    protected List<LineItemAPIIType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemAPIIType }
     * 
     * 
     */
    public List<LineItemAPIIType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemAPIIType>();
        }
