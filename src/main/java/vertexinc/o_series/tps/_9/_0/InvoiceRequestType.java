...
/**
 * The request used to calculate tax at the time of shipping, billing, or invoicing from the
 *                 seller's perspective. Because tax liability is typically incurred at the point of invoicing, Invoicing
 *                 transactions are written to the Tax Journal.
 *             
 * 
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemISIType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:vertexinc:o-series:tps:9:0}InvoiceTransactionGroup"/&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
