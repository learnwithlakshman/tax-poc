...
/**
 * Asset Movement Response message.
 * 
 * <p>Java class for AssetMovementResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AssetMovementResponseType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemAMOType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "AssetMovementResponseType", propOrder = {
    "currency",
    "originalCurrency",
    "companyCodeCurrency",
    "owner",
...
public class AssetMovementResponseType
    extends TaxTransactionResponseType
{
    ...
    public List<LineItemAMOType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemAMOType>();
        }
