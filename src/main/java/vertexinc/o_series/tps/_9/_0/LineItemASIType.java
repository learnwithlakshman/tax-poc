...
/**
 * Line Item declaration for Accrual Synchronization Request message.
 * 
 * <p>Java class for LineItemASIType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemASIType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{urn:vertexinc:o-series:tps:9:0}InputTax" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemASIType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:vertexinc:o-series:tps:9:0}AccrualSyncLineItemGroup"/&gt;
 *       &lt;attribute name="syncType" use="required" type="{urn:vertexinc:o-series:tps:9:0}SyncronizationCodeType" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "LineItemASIType", propOrder = {
    "buyer",
    "vendor",
    "taxOverride",
    "impositionToProcess",
...
public class LineItemASIType {
    ...
    protected List<LineItemASIType> lineItem;
    @XmlAttribute(name = "syncType", required = true)
    ...
    /**
     * The amount that is passed to Vertex O Series from your ERP or host system. Vertex
     *                         O Series uses this amount to calculate the VAT withholding amount for a given line item. This
     *                         field is used for Procurement messages. This field specifies the special tax basis of the line
     *                         item.
     *                     
     * 
     * @return
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemASIType }
     * 
     * 
     */
    public List<LineItemASIType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemASIType>();
        }
