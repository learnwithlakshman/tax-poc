...
/**
 * Line Item declaration for Account Receivable Billing Synchronization Request message.
 * 
 * <p>Java class for LineItemARBIType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemARBIType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemARBIType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:vertexinc:o-series:tps:9:0}ARBillingSyncLineItemGroup"/&gt;
...
@XmlType(name = "LineItemARBIType", propOrder = {
    "seller",
    "customer",
    "taxOverride",
    "impositionToProcess",
...
public class LineItemARBIType {
    ...
    protected List<LineItemARBIType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemARBIType }
     * 
     * 
     */
    public List<LineItemARBIType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemARBIType>();
        }
