...
/**
 * Details on a Line Item that is a child of the transaction. Each transaction requires at
 *                 least one line item. Note that a line item can also contain other line items.
 *             
 * 
 * <p>Java class for LineItemISIType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemISIType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemISIType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:vertexinc:o-series:tps:9:0}InvoiceLineItemGroup"/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "LineItemISIType", propOrder = {
    "seller",
    "customer",
    "taxOverride",
    "impositionToProcess",
...
public class LineItemISIType {
    ...
    protected List<LineItemISIType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemISIType }
     * 
     * 
     */
    public List<LineItemISIType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemISIType>();
        }
