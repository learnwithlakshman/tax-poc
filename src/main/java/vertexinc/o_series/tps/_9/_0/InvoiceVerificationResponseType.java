...
/**
 * Invoice Verification Response message.
 * 
 * <p>Java class for InvoiceVerificationResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="InvoiceVerificationResponseType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{urn:vertexinc:o-series:tps:9:0}AdditionalTaxesDue" minOccurs="0"/&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemIVSOType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attGroup ref="{urn:vertexinc:o-series:tps:9:0}InvoiceVerificationTransactionGroup"/&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "InvoiceVerificationResponseType", propOrder = {
    "currency",
    "originalCurrency",
    "companyCodeCurrency",
    "buyer",
...
public class InvoiceVerificationResponseType
    extends TaxTransactionResponseType
{
    ...
    @XmlElement(name = "AdditionalTaxesDue")
    protected BigDecimal additionalTaxesDue;
    ...
    protected List<LineItemIVSOType> lineItem;
    ...
    /**
     * This value represents any additional consumer use tax that may be due for this jurisdiction.
     * 
     * @return
     *     possible object is
     *     {@link BigDecimal }
     *     
     */
    public BigDecimal getAdditionalTaxesDue() {
        return additionalTaxesDue;
    }

    /**
     * Sets the value of the additionalTaxesDue property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigDecimal }
     *     
     */
    public void setAdditionalTaxesDue(BigDecimal value) {
        this.additionalTaxesDue = value;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemIVSOType }
     * 
     * 
     */
    public List<LineItemIVSOType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemIVSOType>();
        }
