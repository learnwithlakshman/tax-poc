...
/**
 * Line Item declaration for Purchase Order Response message.
 * 
 * <p>Java class for LineItemPOTOType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemPOTOType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemPOTOType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "LineItemPOTOType", propOrder = {
    "buyer",
    "vendor",
    "taxOverride",
    "impositionToProcess",
...
public class LineItemPOTOType {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemPOTOType }
     * 
     * 
     */
    public List<LineItemPOTOType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemPOTOType>();
        }
