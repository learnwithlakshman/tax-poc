...
/**
 * Line Item declaration for Accrual Response message.
 * 
 * <p>Java class for LineItemATOType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LineItemATOType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemATOType" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "LineItemATOType", propOrder = {
    "buyer",
    "vendor",
    "taxOverride",
    "impositionToProcess",
...
public class LineItemATOType {
    ...
    protected List<LineItemATOType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemATOType }
     * 
     * 
     */
    public List<LineItemATOType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemATOType>();
        }
