...
/**
 * The request used to estimate taxes on the proposed sale, rental, or lease of goods or services by the Seller. Quotations may be called from a CRM, Mobile Sale, Order Entry, or Internet Sale application. Because Quotation transactions are subject to change until an invoice is finalized, they are not written to the Tax Journal.
 * 
 * 
 * <p>Java class for QuotationRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="QuotationRequestType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:9:0}LineItemQSIType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "QuotationRequestType", propOrder = {
    "currency",
    "originalCurrency",
    "companyCodeCurrency",
    "seller",
    ...
    extends TaxTransactionRequestType
{
    ...
    protected List<LineItemQSIType> lineItem;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LineItemQSIType }
     * 
     * 
     */
    public List<LineItemQSIType> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<LineItemQSIType>();
        }
